...
const Tag = ({ onRemove, children, ...props }) => ((0, jsx_runtime_1.jsx)(Badge_1.Badge, { ...props, children: (0, jsx_runtime_1.jsxs)(primitives_1.Inline, { align: "center", gap: 1.5, children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", weight: "medium", children: children }), onRemove && ((0, jsx_runtime_1.jsx)(primitives_1.Pressable, { onPress: onRemove, accessibilityLabel: "Remove Tag", children: (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: "rgba(255,255,255,0.6)", children: "\u2715" }) }))] }) }));
exports.Tag = Tag;
...
const Counter = ({ count, max = 99, variant = "danger", style }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(primitives_1.Center, { accessibilityRole: "adjustable", accessibilityValue: { min: 0, max, now: count, text: `${count}` }, style: [
            ...
            style,
        ], children: (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", weight: "bold", color: "#FFF", style: { fontSize: 10 }, children: display }) }));
};
