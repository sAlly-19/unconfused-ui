...
const Sparkline = ({ values = [12, 18, 15, 24, 28, 34, 42], color = "#10B981", trend = "+32.4%", style, }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(primitives_1.Inline, { align: "center", gap: 2, style: style, children: [(0, jsx_runtime_1.jsx)(primitives_1.Inline, { align: "flex-end", gap: 1, style: { height: 20 }, children: values.map((v, i) => ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                    ...
                    } }, i))) }), trend && ((0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", weight: "bold", color: resolvedColor, children: trend }))] }));
};
...
const ProgressChart = ({ tracks, style }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(primitives_1.Box, { style: [
            ...
            style,
        ], children: (0, jsx_runtime_1.jsx)(primitives_1.VStack, { gap: 3, children: tracks.map((track, idx) => ((0, jsx_runtime_1.jsxs)(primitives_1.VStack, { gap: 1, children: [(0, jsx_runtime_1.jsxs)(primitives_1.Inline, { justify: "space-between", align: "center", children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", weight: "medium", color: semanticColors.foreground, children: track.label }), (0, jsx_runtime_1.jsxs)(primitives_1.Text, { size: "xs", weight: "bold", color: track.color, children: [track.value, "%"] })] }), (0, jsx_runtime_1.jsx)(primitives_1.Box, { style: { width: "100%", height: 6, borderRadius: 3, backgroundColor: (0, tokens_1.withAlpha)(baseTokens.colors.white, 0.08), overflow: "hidden" }, children: (0, jsx_runtime_1.jsx)(primitives_1.Box, { style: { width: `${Math.min(100, track.value)}%`, height: "100%", backgroundColor: track.color } }) })] }, idx))) }) }));
};
