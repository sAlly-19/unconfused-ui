...
const ImageBackground = ({ overlayColor, style, children, ...rest }) => {
    const { baseTokens } = (0, theme_1.useTheme)();
    const resolvedOverlay = overlayColor ?? (0, tokens_1.withAlpha)(baseTokens.colors.black, 0.4);
    return ((0, jsx_runtime_1.jsxs)(react_native_1.ImageBackground, { style: [{ overflow: "hidden", position: "relative" }, style], ...rest, children: [resolvedOverlay && ((0, jsx_runtime_1.jsx)(react_native_1.View, { style: {
                    position: "absolute",
                    top: 0,
                    left: 0,
                    right: 0,
...
const ImageViewer = ({ open = false, onClose, title = "Image Preview", src }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(react_native_1.Modal, { visible: open, transparent: true, animationType: "fade", onRequestClose: onClose, children: (0, jsx_runtime_1.jsx)(primitives_1.Pressable, { onPress: onClose, style: {
                ...
                }, children: [(0, jsx_runtime_1.jsxs)(primitives_1.Inline, { justify: "space-between", align: "center", style: { padding: 14 }, children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "sm", weight: "bold", children: title }), (0, jsx_runtime_1.jsx)(primitives_1.Pressable, { onPress: onClose, children: (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "sm", color: semanticColors.foregroundMuted, children: "\u2715" }) })] }), (0, jsx_runtime_1.jsx)(primitives_1.Box, { style: { height: 300, backgroundColor: baseTokens.colors.black, alignItems: "center", justifyContent: "center" }, children: src ? ((0, jsx_runtime_1.jsx)(react_native_1.Image, { source: { uri: src }, style: { width: "100%", height: "100%" }, resizeMode: "contain" })) : ((0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "3xl", children: "\uD83C\uDF0C" })) })] }) }) }));
};
...
const Carousel = ({ items, style }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(primitives_1.Box, { style: [
            ...
            style,
        ], children: (0, jsx_runtime_1.jsxs)(primitives_1.VStack, { gap: 4, children: [(0, jsx_runtime_1.jsxs)(primitives_1.Inline, { justify: "space-between", align: "center", children: [(0, jsx_runtime_1.jsxs)(primitives_1.Text, { size: "xs", weight: "bold", color: semanticColors.primary, style: { textTransform: "uppercase" }, children: ["Slide ", activeIndex + 1, " of ", items.length] }), current?.badge && ((0, jsx_runtime_1.jsx)(primitives_1.Box, { style: { paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6, backgroundColor: (0, tokens_1.withAlpha)(baseTokens.colors.brand[500], 0.2) }, children: (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: baseTokens.colors.brand[400], weight: "bold", children: current.badge }) }))] }), (0, jsx_runtime_1.jsxs)(primitives_1.Box, { style: { minHeight: 70, justifyContent: "center" }, children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "lg", weight: "bold", color: semanticColors.foreground, children: current?.title }), current?.subtitle && ((0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: semanticColors.foregroundMuted, style: { marginTop: 4 }, children: current.subtitle }))] }), (0, jsx_runtime_1.jsxs)(primitives_1.Inline, { justify: "space-between", align: "center", children: [(0, jsx_runtime_1.jsx)(primitives_1.Inline, { gap: 1.5, children: items.map((_, idx) => ((0, jsx_runtime_1.jsx)(primitives_1.Pressable, { onPress: () => setActiveIndex(idx), style: {
                                    width: activeIndex === idx ? 20 : 6,
                                    height: 6,
                                    borderRadius: 3,
                                    backgroundColor: activeIndex === idx ? semanticColors.primary : (0, tokens_1.withAlpha)(baseTokens.colors.white, 0.2),
...
const AudioPlayer = ({ title = "Ambient Space Waves", artist = "Antigravity Synth", duration = "03:45", elapsed = "01:14", style, }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(primitives_1.Box, { style: [
            ...
            style,
        ], children: (0, jsx_runtime_1.jsxs)(primitives_1.VStack, { gap: 3, children: [(0, jsx_runtime_1.jsxs)(primitives_1.Inline, { justify: "space-between", align: "center", children: [(0, jsx_runtime_1.jsxs)(primitives_1.Inline, { align: "center", gap: 3, children: [(0, jsx_runtime_1.jsx)(primitives_1.Center, { circle: 38, bg: playing ? semanticColors.primary : (0, tokens_1.withAlpha)(baseTokens.colors.white, 0.08), children: (0, jsx_runtime_1.jsx)(primitives_1.Pressable, { onPress: () => setPlaying(!playing), children: (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "sm", color: baseTokens.colors.white, children: playing ? "⏸" : "▶" }) }) }), (0, jsx_runtime_1.jsxs)(primitives_1.VStack, { gap: 0, children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "sm", weight: "bold", color: semanticColors.foreground, children: title }), (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: semanticColors.foregroundMuted, children: artist })] })] }), (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: semanticColors.primary, weight: "bold", children: playing ? "Playing" : "Paused" })] }), (0, jsx_runtime_1.jsxs)(primitives_1.VStack, { gap: 1, children: [(0, jsx_runtime_1.jsx)(primitives_1.Box, { style: { width: "100%", height: 6, borderRadius: 3, backgroundColor: (0, tokens_1.withAlpha)(baseTokens.colors.white, 0.1), overflow: "hidden" }, children: (0, jsx_runtime_1.jsx)(primitives_1.Box, { style: { width: "38%", height: "100%", backgroundColor: semanticColors.primary } }) }), (0, jsx_runtime_1.jsxs)(primitives_1.Inline, { justify: "space-between", children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: semanticColors.foregroundSubtle, children: elapsed }), (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: semanticColors.foregroundSubtle, children: duration })] })] })] }) }));
};
...
const Video = ({ title = "Architecture Overview", duration = "12:40", style }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)(primitives_1.Box, { style: [
            ...
            style,
        ], children: [(0, jsx_runtime_1.jsxs)(primitives_1.Box, { style: { height: 180, backgroundColor: (0, tokens_1.withAlpha)(baseTokens.colors.black, 0.9), alignItems: "center", justifyContent: "center", position: "relative" }, children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "4xl", children: "\uD83C\uDFAC" }), (0, jsx_runtime_1.jsx)(primitives_1.Center, { style: {
                            position: "absolute",
                            width: 48,
                            height: 48,
                            borderRadius: 24,
                            backgroundColor: (0, tokens_1.withAlpha)(baseTokens.colors.brand[500], 0.85),
                        }, children: (0, jsx_runtime_1.jsx)(primitives_1.Pressable, { onPress: () => setPlaying(!playing), children: (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "md", color: baseTokens.colors.white, children: playing ? "⏸" : "▶" }) }) })] }), (0, jsx_runtime_1.jsxs)(primitives_1.Inline, { justify: "space-between", align: "center", style: { padding: 14 }, children: [(0, jsx_runtime_1.jsxs)(primitives_1.VStack, { gap: 0, children: [(0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "sm", weight: "bold", children: title }), (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: semanticColors.foregroundMuted, children: "1080p 60fps \u2022 H.265" })] }), (0, jsx_runtime_1.jsx)(primitives_1.Text, { size: "xs", color: semanticColors.primary, weight: "bold", children: duration })] })] }));
};
exports.Video = Video;
