...
exports.calculateFluidSize = calculateFluidSize;
exports.createPerceptualElevation = createPerceptualElevation;
exports.hexToRgb = hexToRgb;
exports.rgbToHex = rgbToHex;
exports.linearize = linearize;
exports.delinearize = delinearize;
...
exports.generateNeutralScale = generateNeutralScale;
/**
 ...
 */
function calculateFluidSize(minPx, maxPx, minViewport = 360, maxViewport = 1200, currentViewport = 768) {
    if (currentViewport <= minViewport)
        return minPx;
    if (currentViewport >= maxViewport)
        return maxPx;
 ...
 */
function createPerceptualElevation(level, baseColorHex = "#8B5CF6", mode = "dark") {
 ...
 */
function generateNeutralScale(familyOrHue = "auto", seedHue = 0) {
    let hue = seedHue;
    let chroma = 0.015;
